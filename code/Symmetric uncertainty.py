...
y=[78.927,80.708,80.371,73.292,72.595,73.522,71.562]
fig,ax=plt.subplots()
...
plt.title('Symmetric Uncertainty',**csfont)
plt.xticks(x_pos,x)
plt.minorticks_on()
...
#df=pd.read_csv("Symmetric_Uncertainty.csv")
#x=df.Classifier_Techniques
#y=df.Accuracy
#plt.bar(x,y,label='Symmetric Uncertainty')
#plt.legend()
#plt.grid()
#plt.show()
